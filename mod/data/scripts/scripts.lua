...
function OnObjectNumber_1_funct_Created(self)
	ObjectGrantUpgrade( self, "Upgrade_AragornBladeMaster" )
...
function ShelobBiggerPowerToLevel3(self)			
	ObjectDoSpecialPower(self, "SpecialAbilityShelobSizeUPToLevel3")
...
function GandalfConsiderUsingDefensePower(self, other, delay, amount) --(self, other)
...
function GaladrielConsiderUsingDefensePower(self, other)		
		ObjectDoSpecialPower(self, "SpecialPowerShieldBubbleGaladriel")
end
...
function OnPorterCreated(self)
	...
	ObjectHideSubObjectPermanently( self, "BANNERS", true )	--true. all true
end
...
function OnEvilPorterCreated(self)
	...
	ObjectHideSubObjectPermanently( self, "GOLD", false )	--true
...
function IsengardPortalFun(self)
	ObjectDoSpecialPower(self, "SpellBookTaintPortal")
end

function OnRingCreated(self)
	ObjectDoSpecialPower(self, "SpecialAbilityRingDissent")
end	

function TotemRemoveUpgrade(self,other)
	ObjectRemoveUpgrade( other, "Upgrade_OrcTrollFaceOK" )
end
...
function Remove_Nazgul_Skin(self)
	...
	ObjectHideSubObjectPermanently( self, "B_NROBE3", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE3", true )
	ObjectHideSubObjectPermanently( self, "BAT_FARML", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE6", true )
	ObjectHideSubObjectPermanently( self, "BAT_NTHIGHL", true )
	ObjectHideSubObjectPermanently( self, "B_NHANDL", true )
	ObjectHideSubObjectPermanently( self, "BAT_NUARML", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE7", true )
	ObjectHideSubObjectPermanently( self, "B_CAPE2", true )
	ObjectHideSubObjectPermanently( self, "BAT_NHEAD", true )
	ObjectHideSubObjectPermanently( self, "B_CAPE1", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE5", true )
	ObjectHideSubObjectPermanently( self, "B_NHANDR", true )
	ObjectHideSubObjectPermanently( self, "B_NROBE4", true )
	ObjectHideSubObjectPermanently( self, "B_NPELVIS", true )
	ObjectHideSubObjectPermanently( self, "BAT_NCALFR", true )
	ObjectHideSubObjectPermanently( self, "BAT_FARMR", true )
	ObjectHideSubObjectPermanently( self, "B_NROBE2", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE1", true )
	ObjectHideSubObjectPermanently( self, "B_NROBE1", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE4", true )
	ObjectHideSubObjectPermanently( self, "BAT_NCALFL", true )
	ObjectHideSubObjectPermanently( self, "B_NSKIRT1", true )
	ObjectHideSubObjectPermanently( self, "B_NSLEEVE2", true )
	ObjectHideSubObjectPermanently( self, "BAT_NTHIGHR", true )
	ObjectHideSubObjectPermanently( self, "B_NSKIRT2", true )
	ObjectHideSubObjectPermanently( self, "B_NTOEL", true )
	ObjectHideSubObjectPermanently( self, "B_NTOER", true )
end

function AIMakeRepairBuildingFuck(self)
	ObjectDoSpecialPower(self, "SpellBookTaintPortal")
end